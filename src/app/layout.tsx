...
export const metadata: Metadata = {
  title: "Carson Loquaci Farm - Premium Organic Produce",
  description: "Experience premium organic farming excellence. Family-owned, certified organic farm delivering fresh, sustainable produce to your table.",
  keywords: "organic farm, organic produce, sustainable agriculture, fresh vegetables, family farm, certified organic",
  metadataBase: new URL("https://carsonloquacifarm.com"),
  alternates: {
    canonical: "https://carsonloquacifarm.com"
  },
  openGraph: {
    title: "Carson Loquaci Farm - Premium Organic Produce",
    description: "Experience premium organic farming excellence with decades of expertise in sustainable agriculture.",
    url: "https://carsonloquacifarm.com",
    siteName: "Carson Loquaci Farm",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1764887631368-h54z34wf.jpg",
        alt: "Carson Loquaci Farm"
      }
    ],
    type: "website"
  },
  twitter: {
    ...
    title: "Carson Loquaci Farm - Premium Organic Produce",
    description: "Premium organic farming and sustainable agriculture",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1764887631368-h54z34wf.jpg"]
  },
  robots: {
    index: true,
    follow: true
